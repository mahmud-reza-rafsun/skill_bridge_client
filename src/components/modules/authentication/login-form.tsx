...
// const UserIcon = () => (
//     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 text-zinc-600 dark:text-zinc-400"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
// );
// const EyeIcon = () => (
...
//             <div className="w-full max-w-sm p-6 space-y-6 bg-white dark:bg-black rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-xl">
...
//                     className="w-full flex items-center justify-center gap-2 h-10 rounded-md border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-all font-medium text-sm">
//                     <GoogleIcon /> Continue with Google
//                 </button>

//                 <div className="relative flex items-center justify-center">
//                     <span className="absolute w-full border-t border-zinc-200 dark:border-zinc-800" />
//                     <span className="relative bg-white dark:bg-black px-3 text-xs text-zinc-400 uppercase">Or</span>
//                 </div>
...
//                     <Link href="/register" className="text-zinc-900 dark:text-white font-bold hover:underline">Sign up</Link>
//                 </p>
//             </div>
//         </div>
//     );
