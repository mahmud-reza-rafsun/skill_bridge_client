            ...
            <div className="w-full max-w-md p-6 space-y-6 bg-white dark:bg-black rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-xl">
                ...
                >
                    ...
                    <div className="grid grid-cols-3 gap-2 pt-2">
                        <button
                            type="button"
                            onClick={() => setCredentials("admin@skill-bridge.com", "12345678")}
                            className="text-[10px] uppercase tracking-wider h-8 rounded border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors font-bold text-zinc-600 dark:text-zinc-400"
                        >
                            Admin
                        </button>
                        <button
                            type="button"
                            onClick={() => setCredentials("tutor@skill-bridge.com", "12345678")}
                            className="text-[10px] uppercase tracking-wider h-8 rounded border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors font-bold text-zinc-600 dark:text-zinc-400"
                        >
                            Tutor
                        </button>
                        <button
                            type="button"
                            onClick={() => setCredentials("student@skill-bridge.com", "12345678")}
                            className="text-[10px] uppercase tracking-wider h-8 rounded border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors font-bold text-zinc-600 dark:text-zinc-400"
                        >
                            Student
                        </button>
